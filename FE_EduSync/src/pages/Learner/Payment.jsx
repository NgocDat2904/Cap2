...
const LearnerCheckoutPage = () => {
  ...
  const orderData = {
    courseTitle: "Lập trình Python: Từ cơ bản đến nâng cao cho người mới bắt đầu",
  ...
  const handleApplyCoupon = (e) => {
    ...
    if (coupon.trim().toUpperCase() === "EDUSYNC2026") {
      ...
      alert("Hệ thống: Mã giảm giá không hợp lệ hoặc đã hết hạn sử dụng.");
  ...
  const handleCheckout = (e) => {
    ...
    alert("Hệ thống: Thanh toán thành công! Đang chuyển hướng đến khóa học của bạn...");
  };
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-slate-500">
                      Hỗ trợ thẻ Visa, Mastercard, JCB, Amex
                    </p>

                    {/* Biểu mẫu nhập thông tin thẻ (Chỉ hiển thị khi chọn Thẻ) */}
                  ...
                  <div className="flex-1">
                    ...
                    {paymentMethod === "momo" && (
                      <div className="mt-4 p-4 bg-white border border-slate-200 rounded-xl text-sm text-slate-600 text-center animate-fade-slide-up">
                        Bạn sẽ được chuyển hướng đến cổng thanh toán an toàn để quét mã QR.
                      </div>
                    )}
                  </div>
                </label>
            ...
            <div className="flex items-start gap-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100 text-emerald-800">
              ...
              <div>
                ...
                <p className="text-xs mt-1 leading-relaxed opacity-90">
                  EduSync sử dụng mã hóa SSL 256-bit chuẩn công nghiệp. Thông tin thẻ của bạn không bao giờ được lưu trữ trên máy chủ của chúng tôi.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-2/5">
            <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50 sticky top-24">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex justify-between items-center text-sm">
                  <span className="text-slate-700 font-bold">Giá ưu đãi:</span>
                ...
                {isCouponApplied && (
                  <div className="flex justify-between items-center text-sm text-emerald-600 font-bold animate-fade-slide-up">
                    <span className="flex items-center gap-1.5">
                      <FontAwesomeIcon icon={faCheckCircle} /> Giảm giá mã:
                    </span>
              ...
              <div>
                ...
                <p className="text-center text-[10px] text-slate-400 mt-4 px-4 leading-relaxed">
                  Bằng cách nhấn Hoàn tất, bạn đồng ý với Điều khoản Dịch vụ và Chính sách Bảo mật của EduSync.
                </p>
              </div>
            </div>
          </div>
