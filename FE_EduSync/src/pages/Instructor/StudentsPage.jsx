...
const InstructorStudentsPage = () => {
  ...
  const courses = [
    ...
    { id: "react", name: "ReactJS in Practice 2026" },
  ];
  ...
  const students = [
    ...
    },
    {
      ...
      avatar: "DT",
      courseId: "react",
      courseName: "ReactJS in Practice 2026",
      enrolledDate: "02/05/2026",
      progress: 0,
    ...
    setTimeout(() => {
      switch (action) {
        ...
        case "reset":
          if (
            window.confirm(
              `Are you sure you want to reset all progress for ${studentName} back to 0%?`,
            )
          ) {
            alert(`Progress for ${studentName} has been reset.`);
          }
          break;
        case "ban":
          if (
            window.confirm(
              `WARNING: You are about to revoke ${studentName}'s course access. The learner will not be refunded. Continue?`,
            )
          ) {
            alert(`Access for ${studentName} has been revoked.`);
          }
          break;
        default:
          break;
