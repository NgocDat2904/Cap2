...
const LearnerLayout = () => {
  ...
  // Gọi API lấy thông tin Người dùng ngay khi Layout load lên
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        console.error("Lỗi khi tải thông tin hồ sơ tại Layout:", error);
      }
    };
    fetchUserData();
  }, []);
  ...
  // Danh sách các đường dẫn điều hướng đã Việt hóa
  const navLinks = [
  ...
  const handleLogout = async (e) => {
    ...
    try {
      ...
      console.error("Lỗi trong quá trình gọi API đăng xuất:", error);
    } finally {
          ...
          <div className="flex-1 max-w-3xl mx-2 sm:mx-8">
            ...
            >
              <input
                ...
                readOnly={!isLoggedIn}
                placeholder={
                  isLoggedIn ? "Tìm kiếm khóa học..." : "Đăng nhập để tìm kiếm khóa học..."
                }
